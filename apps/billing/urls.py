...
urlpatterns = [
    ...
    path('<int:pk>/add-component/<int:line_id>/', views.add_component, name='add_component'),
    ...
    path('<int:pk>/send-tg-payment/', views.send_payment_link_tg, name='send_tg_payment'),
]
